...
async function addRole(){
   ...
   try {
      await api.post('saveRoles', formData,
         { headers: { 'Authorization': `Bearer ${token}` } })
         .then(function (response) {
            error.value = ''
            loading.value = false
...
async function updateRole(){
   ...
   try {
      await api.put('roles/' + roleIdNo.value, formData,
         { headers: { 'Authorization': `Bearer ${token}` } })
         .then(function (response) {
            error.value = ''
            loading.value = false
...
async function updateEquipment(){
   ...
   try {
      await api.put('equipments/' + equipmentIdNo.value, formData,
         { headers: { 'Authorization': `Bearer ${token}` } })
         .then(function (response) {
            error.value = ''
            loading.value = false
                            ...
                            <v-table class="border">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-left"> Date od Birth </th>
